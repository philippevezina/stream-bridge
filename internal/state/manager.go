...
func NewManager(cfg config.StateConfig, clickhouseClient *clickhouse.Client, logger *zap.Logger, clickhouseCluster string, schemaCfg config.SchemaConfig) (*Manager, error) {
	...
	case "clickhouse":
		...
		storage = NewClickHouseStorage(clickhouseClient, logger, stateConfig, clickhouseCluster, schemaCfg.DefaultEngine, schemaCfg.ZooPath, schemaCfg.ReplicaName)
	case "file":
